                        ...
                        <div class="quiz-actions">
                            <?php
                                ...
                                if ($status === 'avaliado') {
                                    ...
                                    // Este link deve apontar para uma página que ainda criaremos
                                ...
                                } elseif ($prazo_encerrado) { // Se o prazo encerrou e não foi finalizado
                                    echo '<span class="status-badge status-prazo-encerrado">Prazo Encerrado</span>';
                                } else {
                                    // O botão para iniciar a prova está correto
